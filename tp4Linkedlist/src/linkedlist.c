...
/** \brief devuelve el elemento guardado en l  lista en el indice especificado
 *
 * \param this LinkedList* Puntero a la lista
...
int ll_clear(LinkedList* this)
{
    ...
    if(this!=NULL)
    {
        for(int i=ll_len(this)-1; i>=0; i--) //recorro el array al reves
        {
            if(ll_remove(this,i)==-1) // si no salio me avisa
            {
                flag=0;
                break;
            }
